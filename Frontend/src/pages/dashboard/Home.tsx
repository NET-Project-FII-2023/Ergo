...
import { CheckBadgeIcon, CheckCircleIcon, ClockIcon, CogIcon, RectangleStackIcon } from "@heroicons/react/24/solid";
            ...
            <TasksStats
              ...
              footer={
                <Typography className="font-normal text-white">
                  Across <strong>{2}</strong> projects
                </Typography>
              }
            />
            <TasksStats
              ...
              footer={
                <Typography className="font-normal text-white">
                  Next due:&nbsp;
                  <strong>9th of February 2024</strong>
                </Typography>
              }
            />
            <TasksStats
              ...
              footer={
                <Typography className="font-normal text-white">
                  <strong>{3}</strong> completed projects
                </Typography>
              }
            />
