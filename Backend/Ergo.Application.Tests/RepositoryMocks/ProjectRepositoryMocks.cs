...
namespace Ergo.Application.Tests.RepositoryMocks
{
    public static class ProjectRepositoryMocks
    {
        ...
        [
            Project.Create("Project 1", "Description 1", null, "GitRepository 1", DateTime.Now.AddDays(1), "FullName 1").Value,
            Project.Create("Project 2", "Description 2", null, null, DateTime.Now.AddDays(2), "FullName 2").Value
        ];
